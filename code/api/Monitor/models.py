...
class BsuEformsschemadetail(models.Model):
    detailid = models.AutoField(unique=True)
...
class BsuEformsschemamaster(models.Model):
    loanid = models.AutoField(unique=True)
...
class BsuOfficeusers(models.Model):
    ...
    lastlogin = models.CharField(max_length=20, blank=True, null=True)
